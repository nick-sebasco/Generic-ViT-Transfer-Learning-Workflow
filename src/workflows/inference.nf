...
process patchInference{
    ...
    output:
        ...
        patth "Mean_Patch_Scores_*.csv"
    script:
    """
    python3 $projectDir/bin/PatchInference.py $image_ids_path $params.feature_dir_path $model_path $params.scan_ds $params.class_order
    """
}
